...
REPORT$IA_LABEL <- as.character(REPORT$IA_LABEL)
ORTHOS$IA_LABEL <- as.character(ORTHOS$IA_LABEL)

# add orthographic values to dataframe
COMBINED <- REPORT %>%
  left_join(ORTHOS[,c("IA_ID","IA_LABEL", "TRIAL_INDEX","OrthoMatchModel")], by = c("IA_ID" = "IA_ID", "IA_LABEL" = "IA_LABEL", "TRIAL_INDEX" = "TRIAL_INDEX"))
